...
public class ControllerE_Commerce {
    ...
    public void start(){
        ...
        ViewE_Commerce view = new ViewE_Commerce();
        ModelE_Commerce model = new ModelE_Commerce();
        ControllerE_CommerceUsers controllerUsers = new ControllerE_CommerceUsers();
        ControllerE_CommerceProduto controllerProduto = new ControllerE_CommerceProduto();
